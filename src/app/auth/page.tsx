      ...
      <div className="w-full max-w-md">
        ...
        <div className="border border-zinc-800 rounded-xl p-8 hover:border-zinc-700 transition-all">
          <button
            ...
            className="w-full bg-white hover:bg-gray-100 text-black font-semibold py-3 px-4 rounded-lg flex items-center justify-center gap-3 transition-all shadow-lg hover:shadow-xl"
          >
